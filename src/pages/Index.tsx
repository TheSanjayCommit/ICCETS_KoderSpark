      ...
      <main className="flex-1">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <ContentBox className="animate-fade-in hover:shadow-xl transition-all duration-500">
            <h2 className="text-2xl sm:text-3xl font-bold mb-6 sm:mb-8 text-center bg-gradient-to-r from-primary via-blue-600 to-primary bg-clip-text text-transparent animate-gradient-x">
              ICCETS 2026
            </h2>
              ...
              <div className="flex items-center justify-between flex-wrap gap-6">
                <div className="animate-slide-up">
                  <p className="text-foreground text-lg hover:text-primary transition-colors duration-300">
                    ...
                    to publish in the proceedings of E3S Web of Conferences.
                  </p>
                </div>
                <div
