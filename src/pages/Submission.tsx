...
//                 <CardContent>
//                   <p className="text-foreground mb-4 sm:mb-6 text-sm sm:text-base">
//                     Authors are requested to follow these guidelines before
...
//                       <div
//                         key={index}
//                         className="flex items-start gap-2 sm:gap-3 group hover:translate-x-1 sm:hover:translate-x-2 transition-transform duration-200"
//                       >
//                         <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-green-500 mt-0.5 flex-shrink-0" />
...
//                 <CardContent className="space-y-4 pt-6">
//                   <p className="text-foreground text-sm sm:text-base lg:text-lg">
//                     We recommend authors to use WORD template. It is planned to
//                     publish the proceedings with "E3S Web of Conferences".
//                   </p>
...
//                         const link = document.createElement("a");
//                         link.href =
//                           "/src/assets/ICCETS 2026_Template_word.docx";
//                         link.download = "ICCETS 2026_Template_word.docx";
//                         document.body.appendChild(link);
//                         link.click();
//                         document.body.removeChild(link);
...
//                     </p>
//                     <p className="text-foreground text-base leading-relaxed">
//                       The authors will need to register their email with CMT to
//                       submit paper to ICCETS 2026. Here is a link how to create
//                       a CMT account:{" "}
//                       <a
...
//                     work (related to the conference theme).
//                   </p>
//                   <p className="text-foreground text-lg">
//                     The review process takes into account both the quality of
//                     writing and the scientific impact of the work. Authors
//                     should clearly identify the problem, explain their
//                     contribution(s), and justify the state-of-the-art works. The
//                     program committee would like to review those who develop,
//                     argue, and provide results.
//                   </p>
//                   <p className="text-foreground text-lg">
//                     Also, note that the (ICCETS) team takes care of plagiarism
//                     (even self-plagiarism) as serious professional misconduct.
//                     All papers will be screened for plagiarism, and the (ICCETS)
//                     team will reject them in case there exists significant
//                     overlap with the previously published papers/papers.
//                   </p>
//                 </CardContent>
//               </Card>
...
//                       research work related to the conference theme. Each paper
//                       should clearly identify the research problem or question,
//                       explain the novelty and significance of the contribution,
//                       describe the methodology and experimental or theoretical
//                       approach, and compare the proposed work with existing
//                       state-of-the-art techniques or research. The paper should
//                       present results in a clear and structured manner using
//                       appropriate figures, tables, and discussions, followed by
//                       meaningful conclusions that highlight key insights,
//                       implications, and possible directions for future work.
//                     </p>
//                   </div>

//                   <p className="text-foreground text-lg">
//                     All submissions must follow the formatting guidelines and
//                     instructions provided in the conference template.
//                   </p>
...
//                     </h4>
//                     <p className="text-foreground text-base">
//                       Regardless of submission types, authors are always advised
//                       to submit their original and unpublished work (related to
            ...
            <div className="space-y-8">
              ...
              <Card className="hover:shadow-lg transition-all duration-300">
                <CardContent className="space-y-4 pt-6">
                  ...
                  <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-950/20 rounded-lg border border-blue-200 dark:border-blue-800">
                    ...
                    <p className="text-foreground text-base leading-relaxed">
                      The authors will need to register their email with CMT to submit paper to ICCETS 2026. Here is a link how to create a
                      CMT account:{" "}
                      <a
                        href="https://cmt3.research.microsoft.com/docs/help/general/account-creation.html"
                        target="_blank"
              ...
              <Card className="border-l-4 border-l-orange-500">
                ...
                <CardContent className="space-y-4">
                  ...
                  <p className="text-foreground text-lg">
                    The review process takes into account both the quality of writing and the scientific impact of the work. Authors should
                    clearly identify the problem, explain their contribution(s), and justify the state-of-the-art works. The program
                    committee would like to review those who develop, argue, and provide results.
                  </p>
                  <p className="text-foreground text-lg">
                    Also, note that the (ICCETS) team takes care of plagiarism (even self-plagiarism) as serious professional misconduct. All
                    papers will be screened for plagiarism, and the (ICCETS) team will reject them in case there exists significant overlap
                    with the previously published papers/papers.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-l-4 border-l-blue-500">
                ...
                <CardContent className="space-y-4">
                  <div className="bg-blue-50 dark:bg-blue-950/20 p-4 rounded-lg">
                    <h4 className="font-bold text-blue-700 dark:text-blue-300 mb-2">Regular paper (8–15 pages):</h4>
                    <p className="text-foreground text-base leading-relaxed">
                      Authors are invited to submit original and unpublished research work related to the conference theme. Each paper should
                      clearly identify the research problem or question, explain the novelty and significance of the contribution, describe
                      the methodology and experimental or theoretical approach, and compare the proposed work with existing state-of-the-art
                      techniques or research. The paper should present results in a clear and structured manner using appropriate figures,
                      tables, and discussions, followed by meaningful conclusions that highlight key insights, implications, and possible
                  ...
                  <div className="mt-6 p-4 bg-yellow-50 dark:bg-yellow-950/20 rounded-lg border border-yellow-200 dark:border-yellow-800">
                    <h4 className="font-bold text-yellow-700 dark:text-yellow-300 mb-2">Important Note</h4>
                    <p className="text-foreground text-base">
                      Regardless of submission types, authors are always advised to submit their original and unpublished work (related to
                      the conference theme).
                    </p>
                  </div>
                </CardContent>
